...
@section('content')
	<div class="container container-min">
		...
		<div class="form-wrapper">
			<form method="post" action="{{ route('signin') }}" autocomplete="" id="form">
				{{ csrf_field() }}
				...
				<p class="controls clearfix">
					<a href="{{ route('forgot') }}" target="_blank" class="float-left">忘记密码？</a>
					<a href="{{ route('signup') }}" target="" class="float-right">还没有帐号？注册一个</a>
				</p>
			</form>
		</div>
	</div>
