        ...
        <div class="container-wrapper">
            <div class="header-line d-flex justify-content-between align-items-center border-bottom">
                <div class="tabs clearfix">
                    <a href="{{ route('center.finances.index') }}">财务明细</a>
                    <a href="{{ route('center.finances.coins') }}" class="active">金币明细</a>
                </div>
            </div>
            <div class="list-wrapper">
                <div class="row pt-5 pb-5 d-flex justify-content-start align-items-center">
                    ...
                    <div class="col mt-3 mt-md-0"><a class="btn btn-primary export" href="<?php echo route('center.finances.coins.export') ?>" id="export" onclick="return confirm('确定导出吗？操作可能需要一些时间');">导出Excel</a></div>
                </div>
